...
namespace StudentRegistrationForm
{
    public partial class frmRegistration : Form
    {
        ...
        private void IbIEmail_Click(object sender, EventArgs e)
        {

        }

        private void IbIName_Click(object sender, EventArgs e)
        {
        ...
        private void IbIName_Click_1(object sender, EventArgs e)
        {
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please select your favorite color!", "ValidationErrors", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            return;
            }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please fill in at least Name and Email beforesaving!", "Validation", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            ...
            //Favorite Color
            $"{(picStudent.Image != null ? "student_picture.jpg" :
            "NoImage")}\n";
            // Image Path
            // Save to text file
